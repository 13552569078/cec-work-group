...
export function getMapIconOption(clusterPointColor: string, textColor: string = 'white') {
  return [
    { count: 50, textColor: textColor, textSize: 12, functionName: 'plusingDot', functionProps: { color: clusterPointColor, radius: 50 } },
    { count: 100, textColor: textColor, textSize: 14, functionName: 'plusingDot', functionProps: { color: clusterPointColor, radius: 75 } },
    { count: 200, textColor: textColor, textSize: 18, functionName: 'plusingDot', functionProps: { color: clusterPointColor, radius: 100 } },
    { count: 500, textColor: textColor, textSize: 20, functionName: 'plusingDot', functionProps: { color: clusterPointColor, radius: 125 } },
    { textColor: textColor, textSize: 22, functionName: 'plusingDot', functionProps: { radius: 150, color: clusterPointColor } }
  ];
}
