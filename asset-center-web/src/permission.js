...
import { setToken, getToken, setSystemFlag } from '@/utils/auth'
...
router.beforeEach(async(to, from, next) => {
  ...
  if (to.path === '/') {
    const defaultOpenRoute = store.getters.routes.find(item => item.defaultOpen)
    if (defaultOpenRoute) {
