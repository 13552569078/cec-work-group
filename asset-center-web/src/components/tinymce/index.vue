...
<template>
  <div class="tinymce-box" :class="{'tinymce-box-disabled': disabled}">
    <vue-tinymce v-if="showIt" v-model="content" :disabled="disabled" :setting="setting" @editorBlur="editorBlur" @tinymceEditorClick="tinymceEditorClick" />
  </div>
</template>
<script>
  ...
  data() {
    return {
      ...
      setting: {
        ...
        language: 'zh_CN',
        plugins: 'link table anchor indent2em lineheight paste',
        min_height: 160,
