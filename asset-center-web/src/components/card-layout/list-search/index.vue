    ...
    runSearch() {
      ...
      Object.keys(this.searchForm).forEach(k => {
        ...
        if (this.searchType === 1) {
          if (this.simpleOptionVal !== 'searchForm.' + k) {
            this.searchForm[k] = ''
          } else if (this.searchForm[k] && this.searchForm[k] !== '' && (typeof this.searchForm[k] === 'number' && this.searchForm[k] > 0 || this.searchForm[k].length)) {
            getIt = true
          }
        } else {
          if (this.searchForm[k] && this.searchForm[k] !== '' && (typeof this.searchForm[k] === 'number' && this.searchForm[k] > 0 || this.searchForm[k].length)) {
            // 有值
            getIt = true
          }
        }
