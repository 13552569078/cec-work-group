...
<template>
  <div class="toolbar">
    <span
      ...
      data-command="undo"
    >
      <span class="iconfont-editor icon-undo" />
    </span>
    <span
      class="command"
      data-command="redo"
    >
      <span class="iconfont-editor icon-redo" />
    </span>
    <span class="separator" />
    <c-tooltip
      :content="i18n['tooltip.zoomIn']"
      placement="bottom"
    >
      <span
        class="command"
        data-command="zoomIn"
      >
        <span class="iconfont-editor icon-zoom-in-o" />
      </span>
    </c-tooltip>
    <c-tooltip
      :content="i18n['tooltip.zoomOut']"
      placement="bottom"
    >
      <span
        class="command"
      ...
      >
        <span class="iconfont-editor icon-zoom-out-o" />
      </span>
    </c-tooltip>
    <c-tooltip
      :content="i18n['tooltip.autoFit']"
      placement="bottom"
    >
      <span
        class="command"
      ...
      >
        <span class="iconfont-editor icon-fit" />
      </span>
    </c-tooltip>
    <c-tooltip
      v-if="!locked"
      :content="i18n['tooltip.delete']"
      placement="bottom"
    >
      <span
        class="command"
        data-command="delete"
      >
        <span class="iconfont-editor icon-delete-o" />
      </span>
    </c-tooltip>
  </div>
</template>
