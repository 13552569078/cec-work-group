  ...
  <div style="width:100%;height:100%;">
    ...
    >
      <template v-slot:content>
        ...
        <div class="" :style="{'min-height':pageStatus === 'detail'?'':'316px'}">
          <c-form
            ref="dataForm2"
            :model="formData"
            label-width="108px"
...
export default {
  ...
  components: { detailBaseInfo, detailLayout, logDialog, creatorInfo, referrassetDialog, objectDetail, interfaceDetail },
  data() {
    return {
      logDialogFlag: false,
      processLog: '',
