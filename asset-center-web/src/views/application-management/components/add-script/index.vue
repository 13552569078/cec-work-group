          ...
          <c-form ref="dataForm2" :model="formData" label-width="108px" class=""
            ...
            <div class="white-box-wrap">
              ...
              <c-row :gutter="0" class="search-box">
                <c-col :span="span *2">
                  <c-form-item label="">
                    <publishAsset :provide="true" :page-status="pageStatus" :show-list="formData.referKpiList" @goDetail="goDetail" @deleteRefer="deleteRefer" @add="openIndexTableDialog"></publishAsset>
                  </c-form-item>
                </c-col>
              </c-row>
            </div>
              ...
              <c-row :gutter="0" class="search-box">
                <c-col :span="span *2">
                  <c-form-item label="" style=" margin-top: 6px; ">
                    ...
                    <c-table :data="formData.referList" :max-height="330" style="width: 100%;line-height: 1;">
