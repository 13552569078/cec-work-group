...
// 事件态势分析
export namespace SituationAnalysis {
  export class RequestParams {
    platformCode?: string;
    endTime?: string;
    startTime?: string;
  ...
  export interface Data {}
  export interface EventNatureSourceData {
    "eventSource"?: number,
    "eventSourceName"?: string,
    "eventUrgentName"?: string,
    "num"?: number
  }
...
// 监督分析
export namespace surveAnalysis {
  export class RequestParams {
    platformCode?: string;
    endTime?: string;
    startTime?: string;
  ...
  export interface Data {}
  export interface TopicMaxData {
    topTopicName: string;
    topTopicNum: number;
    fastTopicName: string;
    fastTopcRate: number;
  }
  export interface RepeatStaticsData {
    recognizeNum: string;
    handleNum: string;
    confirmNum: string;
    rate: string;
  ...
  export interface TopicMaxModel {
    code: number;
    data: TopicMaxData;
    msg: string;
    success: boolean;
  }
  export interface RepeatStaticsModel {
    code: number;
    data: RepeatStaticsData;
    msg: string;
    success: boolean;
  }
}
