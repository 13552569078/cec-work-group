<template>
  <hl-scrollbar :style="`height: ${height};`" class="m-t-xs">
    <hl-group
      ...
      :class="platTypeStyle === 'other' || item.dealStatus ? 'no-line' : ''"
      dir="vertical"
    ...
    >
              ...
              >
                <template #reference>
                  <hl-group class="circle-list">
                    ...
                    <hl-group v-if="item.value2?.length > platSize" align="items-middle">
                      ···
                    </hl-group>
                  </hl-group>
                </template>
      ...
      >
        <hl-group align="items-middle" gap="var(--sm)">
          ...
          <span class="standard-text">{{ item.eventUrgentText }}</span>
        </hl-group>
        <hl-group align="items-middle" gap="var(--sm)">
        ...
        <hl-group align="items-middle" gap="var(--sm)">
          <span class="standard-text">事件状态</span>
          <span class="standard-text">{{ item.eventStatusText }}</span>
          <!-- <span
            :class="[
              'standard-text',
              item.overtimeFlag !== null && item.overtimeFlag === 1
      ...
      <hl-group v-if="platTypeStyle === 'cluster'">
        <hl-group
          v-if="item.dealStatus"
          class="p-l-md p-r-md"
          style="margin-bottom: calc(var(--xl) * 0.3); width: 100%"
          align="items-between"
        >
          <hl-group align="items-middle" gap="var(--sm)">
            <span class="standard-text">事件状态</span>
        ...
        <hl-group v-else class="event-bottom full p-l-md p-r-md" align="items-middle">
          <hl-group class="plat-start static" align="items-left">
            <span class="bottom-title m-r-xs">发起平台:</span>
            <hl-popover
              placement="bottom"
