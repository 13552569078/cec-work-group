...
export default {
  ...
  methods: {
    ...
    runSearch() {
      ...
      const arr = []
      Object.keys(this.searchForm).forEach(k => {
        this.searchForm[k] = typeof this.searchForm[k] === 'number' ? this.searchForm[k] + '' : this.searchForm[k]
        let getIt = false
        if (this.searchType === 1) {
          // console.log(this.simpleOptionVal, 'searchForm.' + k, this.searchForm[k], this.searchForm[k] !== '', this.searchForm[k].length, this.searchForm, 'dddddd')
          if (this.simpleOptionVal !== 'searchForm.' + k) {
            this.searchForm[k] = ''
      ...
      <div class='list-page_header'>
        <div class='search-form-wrap'>
          ...
          >
            ...
            >
              <c-button type='primary' size='small' on-click={ this.runSearch } >查询</c-button>
          ...
          >
            <c-button type='' size='small' on-click={ this.resetSearch }>重置</c-button>
            <c-button type='primary' size='small' on-click={ this.runSearch }>查询</c-button>
