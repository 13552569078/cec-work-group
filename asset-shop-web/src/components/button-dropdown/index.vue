...
<template>
  <div>
    <c-dropdown
      ...
      <c-button :type="btnType" class="btn-dropdown" size="small" :disabled="disabled">{{ text }}<i :class="{'btn-dropdown-icon-arrow c-icon-arrow-down':true,'dropdown-active-arrow':!isShowdropdown}"></i></c-button>
...
.btn-dropdown{
 ...
 .btn-dropdown-icon-arrow.c-icon-arrow-down{
   margin-left: 8px;
