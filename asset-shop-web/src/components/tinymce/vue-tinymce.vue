...
export default {
  ...
  beforeMount() {
    const setting = Object.assign({},
      this.setting,
      {
        ...
        setup: (editor) => {
          ...
          // 解决5版本的编辑器在滚动容器里，toolbar在滚动时候位置不动的问题
          ...
          editor.on('init', () => {
            ...
            editor.on('keyup input', () => { // 只在编辑器中打字才会触发
    ...
    this.editor = this.$tinymce.createEditor(setting.selector, setting)
  },
  mounted() {
