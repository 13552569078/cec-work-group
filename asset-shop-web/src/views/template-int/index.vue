...
<template>
  <div v-infinite-scroll="loader" :infinite-scroll-distance="250" class="home">
    ...
    <div class="main width">
      ...
      <cards v-show="cardList.length" :pack-type="packType" systype="jiekou" :showthird="false" :list="cardList" class="content" custom-click @clickCard="clickCard" @downloadok="downloadok"></cards>
  ...
  data() {
    return {
      ...
      TZ_ASSET_TYPE_TREE: [
        ...
        { label: '接口资源', value: 1, disabled: false }
      ]
    }
  },
  watch: {
  ...
  methods: {
    ...
    async queryData(pageNum) {
      ...
      const params = {
        ...
        tagIdList: [],
        assetTypeList: [2],
        assetSubtypeList: [22], // 指定查询 技术-接口资源
        statIdList: [],
