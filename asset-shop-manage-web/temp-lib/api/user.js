...
const baseURL = getProxyUrl('sso_uc')
const fx_gateway = getProxyUrl('fx_gateway')
...
export const login_url = `${fx_gateway}/login/oauth2/authorization?registrationId=asset-shop-manage&loginSuccessUrl=`
