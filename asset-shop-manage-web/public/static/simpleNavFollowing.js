        ...
        obj.link.click(function (e) {
            ...
            if (!turning) {
                if (!$(this).hasClass("active")) {
                    ...
                    turning = true;
                    if (!callBackState.nav && typeof option.navCallBack === "function") 
                        option.navCallBack(obj.groupId)
                    ...
                    $(__scrollElement).animate({
                        ...
                        setTimeout(function () {
                            turning = false;
                            if (!callBackState.follow && typeof option.followCallBack === "function") option.followCallBack(obj.groupId);
                        }, 20);
                    });
