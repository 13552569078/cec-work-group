...
(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === 'object' && typeof module === 'object') { module.exports = factory(require('vue'), require('screenfull'), require('html2canvas')) } else if (typeof define === 'function' && define.amd) { define('relation-graph', ['vue', 'screenfull', 'html2canvas'], factory) } else if (typeof exports === 'object') { exports['relation-graph'] = factory(require('vue'), require('screenfull'), require('html2canvas')) } else { root['relation-graph'] = factory(root['Vue'], root['screenfull'], root['html2canvas']) }
    ...
    function(module, __webpack_exports__, __webpack_require__) {
      ...
      var SeeksGraphMath = {
        ...
        getCirclePoint4MultiLine: function(x1, y1, x2, y2, n1w, n1h, n2w, n2h, isReserve, allSize, indexOfAll) {
          ...
          var from_y = y1 + n1h / 2
          // 王洪海修改 出去线和进来线不准重合
          var buff_h = ((to_x - from_x) === 0) ? 1 : to_x - from_x
          if (buff_h === 0) {
            return {
              x: from_x,
          ...
          // 王洪海修改线之间距离
          var distance = 120 / (allSize + 1) * (indexOfAll + 1) - 20
          var buff_v = to_y - from_y
          // 王洪海修改线头连接位置调整
          var b = Math.sqrt(Math.pow(buff_h, 2) + Math.pow(buff_v, 2)) * (distance - 40) / buff_h
          var k = buff_v / buff_h
          var m = n1w / 2
          var n = n1h / 2
      ...
      function SeeksCenterLayouter(layoutSetting, graphSetting) {
        ...
        this.placeNodes = function(allNodes, rootNode) {
          ...
          // 王洪海修改rootId中心点处世位置修改
          if (this.allNodes.length === 3) {
            rootNode.lot.y = parseInt((__mapHeight - rootNode.el.offsetHeight) / 2) - 400
          } else {
        ...
        // 王洪海方法重写 this.placeRelativePosition
        this.placeRelativePosition = function(rootNode, analyticResult) {
          var distance_coefficient = this.config.distance_coefficient === undefined ? 600 : this.config.distance_coefficient
          var __level1_r = distance_coefficient
          this.allNodes.forEach(thisNode => {
            if (thisNode.lot.subling.level === 1) {
              ...
              // 王洪海修改rootId中心点处世位置修改
              if (this.allNodes.length === 3) {
                thisNode.lot.y = _point.y + 400
              } else {
                thisNode.lot.y = _point.y
              }
            }
          })
          var __level_r = distance_coefficient
          this.allNodes.forEach(thisNode => {
            if (thisNode.lot.subling.level > 1) {
      ...
      var SeeksRGLink_render = function() {
        ...
        return _vm.lineProps.isHide !== true && _vm.isAllowShowNode(_vm.lineProps.fromNode) && _vm.isAllowShowNode(_vm.lineProps.toNode) ? _c('g', {
          ...
          return [thisRelation.isHide === false ? _c('g', {
            ...
            // class: [thisRelation.styleClass, _vm.graphSetting.checkedLineId == _vm.lineProps.seeks_id ? "c-rg-line-checked" : ""], // 王洪海改造，去掉了 判定前面的
            class: [thisRelation.styleClass, _vm.graphSetting.checkedLineId == _vm.lineProps.seeks_id ? '' : ''], // 王洪海改造，去掉了 判定前面的
            style: {
            ...
            attrs: {
              ...
              fill: 'none',
              // 王洪海修改线上面绑定data数据
              'data-linedata': JSON.stringify(thisRelation.data)
            },
            on: {
              click: function($event) {
                return _vm.onClick($event)
      ...
      var GraphMiniToolBar_render = function() {
        ...
        return _c('div', {
          ...
          staticClass: 'c-mb-text whhtext-fullscreen' // 王洪海修改，加样式
          ...
          staticClass: 'c-mb-text'
        }, [_vm._v('缩小')])]) : _vm._e(), _vm._v(' '),
        _c('div', { // 王洪海改动，新增一个清除按钮
          staticClass: 'c-mb-button whhbtn_clear',
          staticStyle: {
            'margin-top': '0px'
          }
        }, [_c('svg', {
        ...
        _vm.graphSetting.layouts.length > 1 ? _c('div', {
          staticClass: 'c-mb-button'
        }, [_c('svg', {
          staticClass: 'rg-icon',
          attrs: {
          ...
          staticClass: 'c-mb-button whhbtn_auto', // 王洪海
          class: {
          ...
          staticClass: 'c-mb-button whhbtn_reflesh', // 王洪海
          on: {
            click: _vm.refresh
          }
        }, [_c('svg', {
          ...
          staticClass: 'c-mb-button whhbtn_download' // 王洪海
        }, [_c('svg', {
          staticClass: 'rg-icon',
          attrs: {
            'aria-hidden': 'true'
