<template>
  <div class="eventJK_commonMD">
    <div class="title"><span>统计周期任务流出趋势分析</span></div>
...
import { taskEventInViewHistoryTendOptions } from './echartsOptions'
...
export default {
  ...
  methods: {
    async getMdDataFn(dateArr) {
      ...
      const res = await moduleSrv.getTaskOutflowTrend(params)
      if (res.code === SUCCESS_CODE) {
        const useEchartsOptions = taskEventInViewHistoryTendOptions
