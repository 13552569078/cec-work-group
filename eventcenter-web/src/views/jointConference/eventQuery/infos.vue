<template>
  <div class="event-infomation fs14">
    ...
    <div class="bottom">
      <el-button v-if="type === 'send'" type="primary" @click="sendMeeting">发起联席会议</el-button>
      <el-button @click="goback">返回</el-button>
    </div>
    <!-- 会议弹框 -->
    <send-meeting-dialog :dialog-visible.sync="showConfirmDialog" :form-body="formBody" :event-info="eventInfo" />
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    goback() {
      this.$router.push({
        path: '/joint-conference/meeting-event'
      })
    },
