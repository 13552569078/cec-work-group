<!--
 * @description 工作台-经办事件
 * @date 2020-08-21
 * @author lism
-->
<template>
  <event-common-list
    :event-type="EVENT_TYPE_ENUM.workHandle"
...
export default {
  ...
  data() {
    return {
      EVENT_TYPE_ENUM,
      hiddenSearchList: ['areaCascader', 'whistleNum', 'overtimeFlag', 'eventDesc'], // 隐藏的搜索条件
