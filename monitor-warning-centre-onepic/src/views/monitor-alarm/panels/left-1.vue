<template>
  ...
  <hl-dialog v-model="dialogTableVisible" :title="`${systemName}信息列表`" width="calc(var(--xxs) * 300)">
    ...
    <hl-pagination :current-page="pagination.currentPage" :page-sizes="[100, 200, 300, 400]" :page-size="pagination.pageSize" layout="sizes, total, slot, prev, pager, next, jumper" :total="pagination.total" align="items-between" class="w-full m-t-lg" @size-change="handleSizeChange" @current-change="handleCurrentChange">
