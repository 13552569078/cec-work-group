...
const cols = ref([
  ...
  { title: "所属区域", prop: "district", slotName: "district", width: "16em" },
  { title: "来源", prop: "address", slotName: "address", width: "8em" },
  {
    title: "操作",
    slotName: "action",
    width: "8em",
...
const getData = async ({
  ...
  const { data } = await apiVideoDataObj.getFindYLVideoList({
    pageSize,
    pageNo: currentPage,
    ...params,
  });
